...
cxxopts::Options BenchmarkRunner::get_basic_cli_options(const std::string& benchmark_name) {
  ...
  cli_options.add_options()
    ...
    ("chunk_indexes", "Create chunk indexes (separate index per chunk; columns defined by benchmark)", cxxopts::value<bool>()->default_value("true"))  // NOLINT(whitespace/line_length)
